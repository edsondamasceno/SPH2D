...
void (*functionMouseKey)(int b,int state, int x, int y) = NULL;
...
void AddKeyMouse(void (*func)(int b, int state, int x, int y)) {
        functionMouseKey = func;
}
...
void TColor::setColor(unsigned int index) {
	float B1 = 1.0, R = 0.0, G = 0.0, B2 = 0.0;
...
void TriangleColor(Coord coord1, int index1, Coord coord2, int index2,
		Coord coord3, int index3, int max_colors) {
	TColor color;
